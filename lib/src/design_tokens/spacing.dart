...
class TagSpancing {
  ...
  static const paddingTableCompact =
      EdgeInsets.symmetric(horizontal: 12, vertical: 8);
  static const paddingTag = EdgeInsets.symmetric(horizontal: 8, vertical: 6);
  static const paddingTagWithIcon = EdgeInsets.fromLTRB(6, 6, 8, 6);
  static const paddingTagRemovable = EdgeInsets.fromLTRB(8, 6, 6, 6);
  static const paddingTagRemovableWithIcon = EdgeInsets.all(6);
  static const marginBadgeIcon = EdgeInsets.fromLTRB(0, 0, 4, 0);
  static const double spaceXXXSmall = 2;
  ...
  static const double spaceXXXLarge = 52;
}
